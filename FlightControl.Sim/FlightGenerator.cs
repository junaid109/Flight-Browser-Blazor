...
public class FlightGenerator(HttpClient httpClient, ILogger<FlightGenerator> logger)
{
    ...
    {
        _flights.Add(new Flight("FL101", "AA101", 40.7128, -74.0060, 30000, 500, 90, "EnRoute"));
        _flights.Add(new Flight("FL102", "BA202", 51.5074, -0.1278, 32000, 520, 270, "EnRoute"));
        _flights.Add(new Flight("FL103", "DL303", 34.0522, -118.2437, 35000, 510, 45, "EnRoute"));
        _flights.Add(new Flight("FL104", "UA404", 41.8781, -87.6298, 28000, 490, 180, "EnRoute"));
        _flights.Add(new Flight("FL105", "AF505", 48.8566, 2.3522, 31000, 515, 135, "EnRoute"));
    }
}
